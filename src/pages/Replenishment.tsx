...
const Replenishment: React.FC<ReplenishmentProps> = ({ currentUser, cart, setCart, showMobileCart, setShowMobileCart }) => {
  ...
  const playAlarm = () => {
    ...
    // CLEANUP CRÍTICO: Cerrar el contexto para evitar fugas de memoria
    setTimeout(() => {
  ...
  const resetOrderState = () => {
    ...
    setSearchTerm('');
    // Mantener el departamento seleccionado puede ser mejor UX, pero reseteamos para consistencia con lógica previa si se desea.
    // Para mejor flujo continuo, comentamos el reset del departamento.
