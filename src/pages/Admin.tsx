...
import { Download, Users, Package, Trash2, Edit2, Key, X, Save, Eye, Loader2, BarChart as BarChartIcon, BellRing, CheckCircle2 } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] bg-slate-950 flex flex-col h-[100dvh] w-screen">
          ...
          <div className="flex-1 overflow-y-auto overflow-x-auto bg-gray-900 p-4 pb-safe overscroll-contain">
            <div className="min-h-full flex items-center justify-center py-4 min-w-max md:min-w-0">
                ...
                >
                  {/* Passing preview={true} to force it to look good in the modal, 
                      but PDF generator uses preview={false} to enforce A4 size */}
