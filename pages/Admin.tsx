...
const Admin: React.FC<AdminProps> = ({ currentUser, unreadNotificationsCount, initialTab = 'requests' }) => {
  ...
  const handleAddUser = (e: React.FormEvent) => {
    ...
    if (newUser.name && newUser.pin) {
      // FIX: Removed the 'id' property as it is not part of the 'Omit<User, "id">' type expected by 'addUser'.
      // The ID is automatically generated by Firestore's addDoc function.
  ...
  const handleUpdateUser = () => {
    if (editingUser && editingUser.name && editingUser.pin) {
      ...
      // Admins don't need explicit permissions, so clean them up if role is changed to ADMIN
