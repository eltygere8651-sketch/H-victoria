        ...
        <div className="bg-white dark:bg-slate-800 px-4 py-4 md:px-6 md:py-6 border-b border-gray-200 dark:border-slate-700/50 shadow-soft z-10 space-y-4 transition-colors duration-300">
           ...
           <div className="flex overflow-x-auto pb-2 gap-3 no-scrollbar py-2">
             {Object.values(Department).map((dep) => (
               <button
                 ...
                 className={`px-6 py-3 rounded-xl text-base font-bold whitespace-nowrap transition-all shadow-sm ${
                   department === dep 
                     ? 'bg-red-600 text-white shadow-red-200 dark:shadow-none scale-105' 
                     : 'bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:hover:bg-slate-600'
                 }`}
               >
                 {dep}
               </button>
           ...
           <div className="relative">
             ...
             <input 
               ...
               className="w-full pl-12 pr-4 py-4 rounded-2xl border-2 border-gray-100 dark:border-slate-700/50 bg-gray-50 dark:bg-slate-700/50 text-lg focus:bg-white dark:focus:bg-slate-800 focus:border-red-500 dark:focus:border-red-500 focus:ring-0 outline-none transition-all dark:text-white placeholder-gray-400 dark:placeholder-slate-500"
             />
           </div>
        </div>
