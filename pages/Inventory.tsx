    ...
    <div className="font-sans">
      <div className="sticky top-0 z-10 bg-white/80 dark:bg-slate-950/80 backdrop-blur-lg pt-6 pb-4 px-4 md:px-6 border-b border-gray-100 dark:border-slate-800">
        <div className="flex justify-between items-center mb-5">
          <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white tracking-tighter">Inventario</h2>
            ...
            <div className="flex justify-between items-center mb-6">
             ...
             <div className="mb-6 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                />
                <button onClick={handleSaveDepartment} className="bg-red-600 text-white px-6 rounded-xl shadow-lg shadow-button-red hover:bg-red-700 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                  <Save size={20} /><span>{editingDepartment ? 'Actualizar' : 'Añadir'}</span>
                </button>
              </div>
            </div>
            <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
              <h4 className="font-bold text-gray-700 dark:text-slate-300">Existentes</h4>
              {departments.map(dep => (
             ...
             <div className="flex justify-end mt-8">
              <button onClick={() => { setShowManageDepartmentsModal(false); setEditingDepartment(null); setNewDepartmentName(''); }} className="py-3 px-6 text-gray-600 dark:text-slate-400 font-bold bg-gray-100 dark:bg-slate-700/50 rounded-xl hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors active:scale-[0.98]">Cerrar</button>
            </div>
          </div>
        </div>
      )}
